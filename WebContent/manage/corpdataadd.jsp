...
$(function() {	 
		...
		$('#form').form({
			url : '${pageContext.request.contextPath}/quarterDataController/add',
...
"/>
        ...
        <tr> 
          <th>B2B金额(千元)</th>
          <td> <input type="text" name="b2b" class="easyui-numberbox" data-options="required:true"/></td>
          <th>C2C金额(千元)</th>
          <td><input type="text"  name="c2c" class="easyui-numberbox" data-options="required:true"/></td>
          <th>B2C金额(千元)</th>
          <td><input type="text"  name="b2c" class="easyui-numberbox" data-options="required:true"/></td>
        </tr>
        <tr> 
          <th>网站浏览次数(日均浏览量)</th>
          <td><input type="text" name="webViews" class="easyui-numberbox" data-options="required:true"/></td>
          <th>月订单量(件)</th>
          <td><input type="text" name="orderCount" class="easyui-numberbox" data-options="required:true"/></td>
          <th></th>
          <td></td>
        </tr>
        <tr> 
          <th>网上用户情况：个人(位)</th>
          <td><input type="text" name="personUser"  class="easyui-numberbox" data-options="required:true"/></td>
          <th>网上用户情况：企业(个)</th>
          <td><input type="text" name="corpUser" class="easyui-numberbox" data-options="required:true"/></td>
          <th>&nbsp;</th>
          <td>&nbsp;</td>
        </tr>
        <tr> 
          <th>物流配送：自营(千元)</th>
          <td><input type="text" name="selfDelivery" class="easyui-numberbox" data-options="required:true" /></td>
          <th>物流配送：外包(千元)</th>
          <td><input type="text" name="outDelivery" class="easyui-numberbox" data-options="required:true" /></td>
          <th></th>
          <td></td>
        </tr>
        <tr> 
          <th>从事电子商务人员人数(位)</th>
          <td><input type="text" name="ebusinessStaff" class="easyui-numberbox" data-options="required:true" /></td>
          <th>信息技术人员人数(位)</th>
          <td><input type="text" name="networkStaff" class="easyui-numberbox" data-options="required:true" /></td>
          <th>物流配送人员人数(位)</th>
          <td><input type="text" name="deliveryStaff" class="easyui-numberbox" data-options="required:true" /></td>
        </tr>
        <tr> 
          <th>网上支付额金额(千元)</th>
          <td><input type="text" name="netPay" class="easyui-numberbox" data-options="required:true" /></td>
          <th></th>
          <td></td>
          <th></th>
          <td></td>
        ...
        <tr> 
          <th>海外交易额：进口(千元)</th>
          <td> <input type="text" name="foreignImport" class="easyui-numberbox" data-options="required:true" /></td>
          <th>海外交易额:出口(千元)</th>
          <td><input type="text" name="foreignExport" class="easyui-numberbox" data-options="required:true" /></td>
          <th></th>
          <td></td>
        </tr>
        <tr> 
          <th>外省市交易额:外销(千元)</th>
          <td><input type="text" name="inlandSale" class="easyui-numberbox" data-options="required:true" ></td>
          <th>外省市交易额:采购(千元)</th>
          <td><input type="text" name="inlandBuy" class="easyui-numberbox" data-options="required:true" ></td>
          <th>&nbsp;</th>
          <td>&nbsp;</td>
        </tr>
        <tr> 
