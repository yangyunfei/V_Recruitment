	...
	<div style="padding:10px 60px 20px 60px">
     <form id="form" method="post">
     	 <input type="hidden" name="ct_app.user_id" value="${user.id }"></input>
     	  <input type="hidden" name="ct_rent.user_id" value="${user.id }"></input>
           <input type="hidden" name="ct_app.type" value="2"></input>
       
         <table cellpadding="5" >
             <tr>
                 <td style="width:15%;">客户姓名:</td>
                 <td style="width:35%;">
					<input class="easyui-textbox " type="text" name="ct_app.name" data-options="required:true" missingMessage="不能为空"></input> 
                </td>
                <td>客户联系方式:</td>
                 <td>
                 	<input class="easyui-textbox " type="text" name="ct_app.phone" data-options="required:true" missingMessage="不能为空"></input>
                 </td>
             </tr>
             <tr>
                <!--  <td>客户来源:</td>
             ...
             <tr>
                 <td>年租金范围:</td>
                 <td>
					<input id="rentMin" style="width:55px;" name="ct_rent.rent_min" class="easyui-numberbox" min="0" min="50000" max="20000000" precision="2" required="true" missingMessage="必须填写5~2000万之间的数字"></input>
                 	--
                 	<input id="rentMax" style="width:55px;" name="ct_rent.rent_max" class="easyui-numberbox" min="0" min="50000" max="20000000" precision="2" required="true" missingMessage="必须填写5~2000万之间的数字"></input>
                 	（元）
				 </td> 
                 <td>面积范围:</td>
                 <td>
                 	<input id="areaMin" style="width:55px;" name="ct_rent.area_min" class="easyui-numberbox" min="0" max="2000" precision="2" required="true" missingMessage="必须填写0~2000之间的数字"></input>
                 	--
                 	<input id="areaMax" style="width:55px;" name="ct_rent.area_max" class="easyui-numberbox" min="0" max="2000" precision="2" required="true" missingMessage="必须填写0~2000之间的数字"></input>
                 	（平方米）
                 </td>
             </tr>
             ...
             <tr>
            	 ...
            	 <td>客户标签:</td>
                 <td>
                 	<select  class="easyui-combobox" name="ct_app.label" style="width:130px;">
             ...
             <tr>
                 <td>客户描述:</td>
                 <td colspan="3"><input class="easyui-textbox" name="ct_rent.description" data-options="multiline:true" style="height:60px;width:500px;"></input></td>
             </tr>
         </table>
     </form>
     <!-- 
