...
<script type="text/javascript">
	...
	$(function() {
		dataGrid = $('#dataGrid')
				.datagrid(
						{
							url : '${pageContext.request.contextPath}/jf/storeController/dataGrid',
							fit : true,
							fitColumns : false,
							border : false,
							pagination : true,
	...
	function add(id) {
		...
		parent.addTab({
			url : '${pageContext.request.contextPath}/jf/storeController/add',
			title : '增加商铺',
	...
	function update(id, storeid) {
		...
		parent
				.addTab({
					url : '${pageContext.request.contextPath}/jf/storeController/update/'
							+ id,
					title : '修改商铺-' + storeid,
					iconCls : 'status_online'
				});
				...
				.confirm(
						...
						function(b) {
							if (b) {
								...
								$
										.post(
												'${pageContext.request.contextPath}/jf/storeController/del',
												{
													id : id
												},
												function(result) {
				...
				.confirm(
						...
						function(b) {
							if (b) {
								...
								$
										.post(
												'${pageContext.request.contextPath}/jf/storeController/spread',
												{
													id : id
												},
												function(result) {
	...
	function xview(id) {
		...
		parent.$
				.modalDialog({
					...
					height : 600,
					onOpen : null,
					href : '${pageContext.request.contextPath}/jf/storeController/view?id='
							+ id,
					buttons : []
				});
	}
