...
<script type="text/javascript" charset="utf-8">
	...
	function logoutFun(b) {
		/* $.getJSON('${pageContext.request.contextPath}/jf/loginController/logout', {
			t : new Date()
		}, function(result) {
			if (b) {
		...
		location.replace('${pageContext.request.contextPath}/jf/loginController/logout');
	}
	...
	function editCurrentUserPwd() {
		parent.$.modalDialog({
			...
			width : 500,
			height : 250,
			href : '${pageContext.request.contextPath}/jf/userController/editPwdPage',
			buttons : [ {
				text : '修改',
				handler : function() {
...
<div id="sessionInfoDiv" style="position: absolute; right: 0px; top: 0px;" class="alert alert-info">
	<c:if test="${sessionInfo.id != null}">[<strong>${sessionInfo.name}</strong>]，欢迎你！</c:if>
</div>
 -->
<div style="position: absolute; right: 0px; bottom: 0px;">
	 <a href="javascript:void(0);" class="easyui-linkbutton" data-options="iconCls:'cog',plain:true"   onclick="editCurrentUserPwd();">修改密码</a> <a href="javascript:void(0);" class="easyui-linkbutton" data-options="iconCls:'cog',plain:true"   onclick="logoutFun(true);">退出系统</a>
</div>
...
<div id="layout_north_kzmbMenu" style="width: 100px; display: none;" onclick="editCurrentUserPwd();">
</div>
