				...
				.datagrid(
						{
							...
							queryParams: {"sec.state.i.eq": state},
							fit : true,
							fitColumns : false,
							border : false,
							pagination : true,
									...
									,
									{
										...
										formatter : function(value, row, index) {
											...
											if(row.state == 3)
											{
												str += $
												.formatString(
														'<a href="javascript:void(0);" onclick="pass(\'{0}\');" >未参加培训</a>',
														row.id);
												str += "&nbsp;&nbsp;";
												str += $
												.formatString(
														'<a href="javascript:void(0);" onclick="nopass(\'{0}\');" >通过</a>',
														row.id);
												str += "&nbsp;&nbsp;";
												str += $
												.formatString(
														'<a href="javascript:void(0);" onclick="EditInterview(\'{0}\');" >淘汰</a>',
														row.id);
												str += "&nbsp;&nbsp;";
												str += $
												.formatString(
...
-->
				...
				<input name="sec.state.i.eq" type="hidden" value="${state}" />
			</form>
		</div>
