     ...
     <form id="form" method="post">
         ...
         <table cellpadding="5" >
             ...
             <tr>
                 ...
                 <td style="width:35%;">
					<input class="easyui-textbox" type="text" name="school_name" data-options="required:true" missingMessage="不能为空" value="${presentee.school_name }"></input> 
                </td>              
             </tr>    
             <tr>
                 <td>学校级别:</td>
                 <td>
            	 <input class="easyui-textbox" type="text" name="school_level" data-options="required:true" missingMessage="不能为空" value="${presentee.school_level }"></input>
            	 </td>
             </tr>     
             <tr>
                 <td>地址:</td>
                 <td>
            	 <input class="easyui-textbox" type="text" name="address" data-options="required:true" missingMessage="不能为空" value="${presentee.address }"></input>
            	 </td>
             </tr>                 
             <tr>
                 <td>描述:</td>
