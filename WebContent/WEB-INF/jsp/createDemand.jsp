...
jQuery(window).resize(function(){
	...
	function validation() {
		...
		var address = $("#address").val().trim(); //店面详细地址
		var trafficRoutes = $("#trafficRoutes").val().trim(); //周边交通路线
...
<div class="main">
    ...
    <!-- mid start -->
    <div class="mid">
        <form action="${basePath}createDemandSave.do" name="applicantForm" method="post" id="applicantForm">
        	<div class="orderul">
                <ul>
                <div class="headinfo">个人信息</div>
                    <li class="orderullih">
                        ...
                        <div class="orderullirw">
                            <input id="phonenumber" name="phone"  type="text" class="contarl-input" placeholder="请输入手机号码" value="${recruitInfo.phone}" required title=""/>
                        </div>
                    </li>
                    <li class="orderullih">
                        <div class="orderullilw"><em class="red">*</em>任店经理时间:</div>
                        <div class="orderullirw">
                            <input id="cardStartDate" name="entryTime" type="text" class="contarl-input" placeholder="点击选择时间" value="" required/>
                        </div>
                    </li>
                 <div class="headinfo">店面信息</div>
                    <li class="orderullih">
                        ...
                        <div class="orderullirw">
                            <input id="orgName" name="orgName" type="text" class="contarl-input" placeholder="请输入店面名称" value="${recruitInfo.orgName }" required/>
                        </div>
                    </li>
                    <li class="orderullih">
                        <div class="orderullilw"><em class="red">*</em>店编码:</div>
                        <div class="orderullirw">
                            <input id="orgCode" name="orgCode" type="text" class="contarl-input" placeholder="请输入店编码" value="" required/>
                        </div> 
                    </li>
                    <li class="orderullih">
                        <div class="orderullilw"><em class="red">*</em>所在大区:</div>
                        <div class="orderullirw">
                            <input id="remPart" name="remPart" type="text" class="contarl-input" placeholder="请输入所属运营大区或部门" value=""/>
                        </div> 
                    </li>
                     <li class="orderulli">
                        <div class="orderullilw paddingtop"><em class="red">*</em>店面详细地址:</div>
                        <div class="orderullirw orderullirwwidth">
                            <textarea name="address" class="contral-textarea" id="address"></textarea>
                        </div>
                    </li>
                    <li class="orderulli">
                      <!--   <div class="orderullilw nofloat">关键词:</div> -->
                        <div class="d">
                            ...
                            <div class="orderullirw">
                            <select class="shortselect" name="cityProper.id" id="cityProperId">
                       ...
                       <!--           <div class="select">
                        ...
                        <div class="d">
                            ...
                            <div class="orderullirw orderullirwwidth">
                                <textarea name="keyword1" id="keyword1" placeholder="如崇文门，幸福家园，多个词用逗号隔开" class="contral-textarea"></textarea>
                            </div>
                            <div class="clear"></div>
                        </div>
                    </li>
                    <li class="orderulli">
                        ...
                        <div class="orderullirw orderullirwwidth">
                            <textarea name="trafficRoutes" id="trafficRoutes" class="contral-textarea"></textarea>
                        </div>
                    </li>
                    <li class="orderulli">
                        <div class="orderullilw paddingtop">补充说明:</div>
                        <div class="orderullirw orderullirwwidth">
                            <textarea name="other" class="contral-textarea" placeholder="如所获荣誉、个人链家经历等"></textarea>
                        </div>
                    </li>
                </ul>
                <div class="btn">
                    <div class="loginbtn greenbtn"><input type="submit" id="submitForm" value="提交" /></div>
            <!--       <div class="loginbtn twobtn graybtn"><input type="submit" value="草稿" /></div> -->  
                    <div class="clear"></div>
                </div>
    <!--              
                <div class="btn">
                    <div class="loginbtn twobtn greenbtn"><input type="button" value="test" id="test"/></div>
